...
var acel : Vector2
#var friction
@onready var sprite_item = $sprite_item
...
func flash_effect():
	sprite_item.material.set_shader_parameter("flash_modifier", 0.6)
	await get_tree().create_timer(0.1).timeout
	sprite_item.material.set_shader_parameter("flash_modifier", 0.0)
